      ...
      <div className="bg-utils-white flex flex-row justify-evenly items-center h-[160px] ">
        <div className="flex flex-row ">
          ...
          <div className="font-Prompt ml-[100px]">
            ...
            <br />
            <div className="font-Prompt text-[14px] font-[400] leading-[21px] text-grey-800">
              452 ซอยสุขุมวิท 79 แขวงพระโขนงเหนือ เขตวัฒนา กรุงเทพมหานคร 10260
            </div>
          </div>
          <div className="ml-[100px]">
            <div className="font-Prompt text-grey-800 text-[16px] font-[400] flex flex-row">
              <img src="https://kpxesshawklisjhmjqai.supabase.co/storage/v1/object/sign/dev-storage/icon/phone_black_24dp%201.svg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJkZXYtc3RvcmFnZS9pY29uL3Bob25lX2JsYWNrXzI0ZHAgMS5zdmciLCJpYXQiOjE2OTQ4Njc0NDYsImV4cCI6MTcyNjQwMzQ0Nn0.ph-HkI3aviWFvDDgaycVliCFCntdQ2gC4eUffeK5e3g&t=2023-09-16T12%3A30%3A46.836Z"></img>
              080-540-6357
            </div>
            <div className="font-Prompt text-grey-800 text-[16px] font-[400] flex flex-row">
              <img src="https://kpxesshawklisjhmjqai.supabase.co/storage/v1/object/sign/dev-storage/icon/email_black_24dp%201.svg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJkZXYtc3RvcmFnZS9pY29uL2VtYWlsX2JsYWNrXzI0ZHAgMS5zdmciLCJpYXQiOjE2OTQ4Njc2NzAsImV4cCI6MTcyNjQwMzY3MH0.zApFRr8dwxiTqsroSCUO6Pg-s3pFglyGe64M5555jzU&t=2023-09-16T12%3A34%3A30.534Z"></img>
